...
public class Config
{
    ...
    public static final String LABEL[]={"Entrada","Salida","Vértices","Lados"};
    public static final Skin SKIN=new Skin(Gdx.files.internal("skin/light-mdpi/Holo-light-mdpi.json"));
